...
> **📋 Prerequisites:** Spring Boot 3.x knowledge, basic understanding of gRPC
> **🎯 Key Topics:** Spring gRPC setup • Service implementation • Client configuration • Testing
...
└─────────────────────────────────────────┘
                   ↓
┌─────────────────────────────────────────┐
│   gRPC Service Layer (@GrpcService)     │
│   - OrderServiceImpl                    │
...
│   (Auto-configuration, Server, Client)  │
└─────────────────────────────────────────┘
                   ↓
┌─────────────────────────────────────────┐
...
│   ├── grpc/                        # gRPC layer
│   │   ├── OrderServiceGrpc.java   # Generated by protoc
│   │   ├── OrderServiceImpl.java   # Your implementation
│   │   └── interceptors/
...
│       └── GrpcConfig.java
└── resources/
    └── application.yml              # gRPC configuration
...
**Navigation:** [← Back to Spring Guide](/languages/spring/README.md) | [Getting Started →](getting-started.md)
